...
#        Next_Area = AT_UR
#        Users[i][2] = Next_Area
#        t_Urgent = random.randint(50, 4*60)
#        Users[i][3] = t_Urgent
#        Users[i][4] = 0
#        interact = [random.randint(1, t_Urgent) for _ in range(N_interaction)]
#        Users[i][6] = interact[0]
#        
#    if N_URG == Curr_Area:
#        Next_Area = At_NU
#        Users[i][2] = Next_Area
...
#        Users[i][3] = t_N_Urgen
#        Users[i][4] = 0
#        interact = [random.randint(1, t_N_Urgen) for _ in range(N_interaction)]
#        Users[i][6] = interact[0]
...
def invasi_emerg_funct(agent,i):
#    day_current = day
    t_med_invasi = random.randint(30, 3*60)
    agent[8] = agent[2]
    agent[7] = agent[6] + t_med_invasi
    agent[2] = INVAS
    return


def neg_pres_room_funct(agent,i):
#    day_current = day
    t_neg_pres = random.randint(30, 5*60)
    agent[8] = agent[2]
    agent[7] = agent[6] + t_neg_pres
    agent[2] = NEGAT
    return
